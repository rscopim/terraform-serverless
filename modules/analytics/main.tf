...
# Lambda function with TWO handlers (analytics + report)
...
# Separate Lambda function alias for the report handler
...
# API Gateway integration (GET /analytics on existing API)
...
# EventBridge rule - every Monday at 8:00 AM UTC (5:00 AM Brasilia)
