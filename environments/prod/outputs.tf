...
output "admin_login_lambda_name" {
  description = "Nome da Lambda responsável pelo login administrativo"
  value       = module.admin_auth.admin_login_function_name
}

output "admin_login_lambda_arn" {
  description = "ARN da Lambda responsável pelo login administrativo"
  value       = module.admin_auth.admin_login_function_arn
}

output "admin_users_lambda_name" {
  description = "Nome da Lambda responsável pela gestão de usuários"
  value       = module.admin_auth.admin_users_function_name
}

output "admin_users_lambda_arn" {
  description = "ARN da Lambda responsável pela gestão de usuários"
  value       = module.admin_auth.admin_users_function_arn
}
